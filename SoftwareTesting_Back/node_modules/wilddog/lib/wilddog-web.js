...
(function(ns){var CLIENT_VERSION = "0.6.0";var NODE_CLIENT=0;ns.wrapper=function(good,wd){
var h,aa=this;function m(a){return void 0!==a}function ba(){}function ca(a){a.Ua=function(){return a.nd?a.nd:a.nd=new a}}
...
(k=String(k)),k=p(k)?/^\s*-?0x/i.test(k)?parseInt(k,16):parseInt(k,10):NaN)}return{host:b,port:k,domain:c,ie:d,ab:f,scheme:g,yb:e}}function qd(a){return fa(a)&&(a!=a||a==Number.POSITIVE_INFINITY||a==Number.NEGATIVE_INFINITY)}function wa(a,b){if(a===b)return 0;if("[MIN_NAME]"===a||"[MAX_NAME]"===b)return-1;if("[MIN_NAME]"===b||"[MAX_NAME]"===a)return 1;var c=rd(a),d=rd(b);return null!==c?null!==d?0==c-d?a.length-b.length:c-d:-1:null!==d?1:a<b?-1:1}
...
function be(a){this.count=parseInt(Math.log(a+1)/ae,10);this.gd=this.count-1;this.Nd=a+1&parseInt(Array(this.count+1).join("1"),2)}function ce(a){var b=!(a.Nd&1<<a.gd);a.gd--;return b}
...
function Ge(a,b,c){if(null!=b.value)return c.M(a,b.value);var d=null;b.children.ja(function(b,f){".priority"===b?(C(null!==f.value,"Priority writes must always be leaf nodes"),d=f.value):c=Ge(a.G(b),f,c)});c.ia(a).j()||null===d||(c=c.M(a.G(".priority"),d));return c};ma.qe;function He(){this.f=Ae;this.g=[];this.m=-1}h=He.prototype;
...
h.oc=function(a,b){var c=eg(this);c.ma=!0;m(a)||(a=null);c.tb=a;null!=b?(c.cb=!0,c.Xa=b):(c.cb=!1,c.Xa="");return c};h.$b=function(a,b){var c=eg(this);c.na=!0;m(a)||(a=null);c.rb=a;m(b)?(c.lb=!0,c.Wa=b):(c.we=!1,c.Wa="");return c};function fg(a,b){var c=eg(a);c.w=b;return c}function gg(a){var b={};a.ma&&(b.sp=a.tb,a.cb&&(b.sn=a.Xa));a.na&&(b.ep=a.rb,a.lb&&(b.en=a.Wa));if(a.ka){b.l=a.la;var c=a.fb;""===c&&(c=ag(a)?"l":"r");b.vf=c}a.w!==E&&(b.i=a.w.toString());return b}
...
function Yg(a,b,c){var d={cancel:null,context:null};if(b&&c)d.cancel=b,N(a,3,d.cancel,!0),d.context=c,zb(a,4,d.context);else if(b)if("object"===typeof b&&null!==b)d.context=b;else if("function"===typeof b)d.cancel=b;else throw Error(M(a,3,!0)+" must either be a cancel callback or a context object.");return d};var $g={},ah=null;"undefined"!=typeof require&&"undefined"!==typeof module&&module.exports?ah=require("engine.io-client"):ah=eio;function bh(a,b,c,d,e){this.W=a;this.m=nd("c:"+this.W+":");this.ca=c;this.I=d;this.B=e;this.f=b;this.u=0;this.m("Connection created");this.g=ch(this);this.g.on("open",dh(this));this.g.on("error",eh(this))}function dh(a){return function(){a.g.on("message",fh(a));a.g.on("close",gh(a))}}
...
h.xd=function(a,b,c,d){this.Zb++;var e=new z(a);b=this.Nc?this.Nc(a,b):b;a=[];d?c?(b=ec(b,function(a){return D(a)}),a=Nf(this.f,e,b,d)):(b=D(b),a=Jf(this.f,e,b,d)):c?(d=ec(b,function(a){return D(a)}),a=If(this.f,e,d)):(d=D(b),a=Ff(this.f,new sa(Bd,e,d)));d=e;0<a.length&&(d=yh(this,e));db(this.g,d,a)};h.wd=function(a){vh(this,"connected",a);!1===a&&zh(this)};h.le=function(a){var b=this;td(a,function(a,d){vh(b,d,a)})};h.ke=function(a){vh(this,"authenticated",a)};
function vh(a,b,c){b=new z("/.info/"+b);c=D(c);var d=a.Ha;d.mc=d.mc.M(b,c);c=Ff(a.W,new sa(Bd,b,c));db(a.g,b,c)}h.bb=function(a,b,c,d){this.Qb("set",{path:a.toString(),value:b,ue:c});var e=xh(this);b=D(b,c);var e=La(b,e),f=this.ca++,e=Ef(this.f,a,e,f,!0);$a(this.g,e);var g=this;this.m.Eb(a.toString(),b.N(!0),function(b,c){var e="ok"===b;e||S("set at "+a+" failed: "+b);e=Hf(g.f,f,!e);db(g.g,a,e);Ah(d,b,c)});e=Bh(this,a);yh(this,e);db(this.g,e,[])};
h.update=function(a,b,c){this.Qb("update",{path:a.toString(),value:b});var d=!0,e=xh(this),f={};P(b,function(a,b){d=!1;var c=D(a);f[b]=La(c,e)});if(d)fb("update() called with empty data.  Don't do anything."),Ah(c,"ok");else{var g=this.ca++,k=Gf(this.f,a,f,g);$a(this.g,k);var l=this;this.m.pd(a.toString(),b,function(b,d){var e="ok"===b;e||S("update at "+a+" failed: "+b);var e=Hf(l.f,g,!e),f=a;0<e.length&&(f=yh(l,a));db(l.g,f,e);Ah(c,b,d)});b=Bh(this,a);yh(this,b);db(this.g,a,[])}};
...
function Eh(a,b,c,d){var e=!0,f;for(f in c)e=!1;e?(fb("onDisconnect().update() called with empty data.  Don't do anything."),Ah(d,"ok")):a.m.qd(b.toString(),c,function(e,f){if("ok"===e)for(var l in c){var n=D(c[l]);a.B.Ab(b.G(l),n)}Ah(d,e,f)})}function Zg(a,b,c){c=".info"===B(b.path)?a.W.hb(b,c):a.f.hb(b,c);bb(a.g,b.path,c)}h.Ya=function(){this.Ga&&this.Ga.Ya()};h.Cb=function(){this.Ga&&this.Ga.Cb()};
h.$c=function(a){if("undefined"!==typeof console){a?(this.sa||(this.sa=new ya(this.ta)),a=this.sa.get()):a=this.ta.get();var b=rc(jc(a),function(a,b){return Math.max(b.length,a)},0),c;for(c in a){for(var d=a[c],e=c.length;e<b+2;e++)c+=" ";console.log(c+d)}}};h.ad=function(a){var b=this.ta,c;m(c)||(c=1);x(b.f,a)||(b.f[a]=0);b.f[a]+=c;this.gb.ud[a]=!0};h.Qb=function(a){var b="";this.Ga&&(b=this.Ga.xc+":");fb(b,arguments)};
function Ah(a,b,c){a&&gb(function(){if("ok"==b)a(null);else{var d=(b||"error").toUpperCase(),e=d;c&&(e+=": "+c);e=Error(e);e.code=d;a(e)}})};ma.oe;
function Fh(a,b,c,d,e){function f(){}a.Qb("transaction on "+b);var g=new V(a,b);g.Za("value",f);c={path:b,update:c,S:d,status:null,sd:fd(),fd:e,td:0,sc:function(){g.xb("value",f)},yc:null,ua:null,Wb:null,Xb:null,Yb:null};d=a.f.qa(b,void 0)||O;c.Wb=d;d=c.update(d.N());if(m(d)){Jg("transaction failed: Data returned ",d,c.path);c.status=1;e=Pe(a.u,b);var k=e.va()||[];k.push(c);Qe(e,k);"object"===typeof d&&null!==d&&x(d,".priority")?(k=J(d,".priority"),C(Hg(k),"Invalid priority returned by transaction. Priority must be a valid string, finite number, server value, or null.")):k=
(a.f.qa(b)||O).J().N();e=xh(a);d=D(d,k);e=La(d,e);c.Xb=d;c.Yb=e;c.ua=a.ca++;c=Ef(a.f,b,e,c.ua,c.fd);db(a.g,b,c);Gh(a)}else c.sc(),c.Xb=null,c.Yb=null,c.S&&(a=new U(c.Wb,new V(a,c.path),E),c.S(null,!1,a))}function Gh(a,b){var c=b||a.u;b||Hh(a,c);if(null!==c.va()){var d=Ih(a,c);C(0<d.length,"Sending zero length transaction queue");sc(d,function(a){return 1===a.status})&&Jh(a,c.path(),d)}else c.dc()&&c.X(function(b){Gh(a,b)})}
function Jh(a,b,c){for(var d=qc(c,function(a){return a.ua}),e=a.f.qa(b,d)||O,d=e,e=e.hash(),f=0;f<c.length;f++){var g=c[f];C(1===g.status,"tryToSendTransactionQueue_: items in queue should all be run.");g.status=2;g.td++;var k=A(b,g.path),d=d.M(k,g.Xb)}d=d.N(!0);a.m.Eb(b.toString(),d,function(d){a.Qb("transaction put response",{path:b.toString(),status:d});var e=[];if("ok"===d){d=[];for(f=0;f<c.length;f++){c[f].status=3;e=e.concat(Hf(a.f,c[f].ua));if(c[f].S){var g=c[f].Yb,k=new V(a,c[f].path);d.push(q(c[f].S,
...
this.oa,a,b)};Y.prototype.update=Y.prototype.update;var Z={};Z.Fb=hh;Z.DataConnection=Z.Fb;hh.prototype.Dd=function(a,b){this.xa("q",{p:a},b)};Z.Fb.prototype.simpleListen=Z.Fb.prototype.Dd;hh.prototype.Bd=function(a,b){this.xa("echo",{d:a},b)};Z.Fb.prototype.echo=Z.Fb.prototype.Bd;hh.prototype.interrupt=hh.prototype.Ya;Z.Fd=bh;Z.RealTimeConnection=Z.Fd;bh.prototype.sendRequest=bh.prototype.xa;bh.prototype.close=bh.prototype.close;
Z.Ud=function(a){var b=hh.prototype.Eb;hh.prototype.Eb=function(c,d,e,f){m(f)&&(f=a());b.call(this,c,d,e,f)};return function(){hh.prototype.Eb=b}};Z.hijackHash=Z.Ud;Z.Ad=sb;Z.ConnectionTarget=Z.Ad;Z.ra=function(a){return a.ra()};Z.queryIdentifier=Z.ra;Z.Wd=function(a){return a.A.Ga.ea};Z.listens=Z.Wd;Z.Gc=function(a){a.Gc()};Z.forceRestClient=Z.Gc;function V(a,b){var c,d,e;if(a instanceof uh)c=a,d=b;else{L("new Wilddog",1,2,arguments.length);d=Tb(arguments[0]);c=d.ie;"wilddog"===d.domain&&pd(d.host+" is no longer supported. Please use <YOUR WILDDOG>.wilddogio.com instead");c||pd("Cannot parse Wilddog url. Please use https://<YOUR WILDDOG>.wilddogio.com");d.ab||"undefined"!==typeof window&&window.location&&window.location.protocol&&-1!==window.location.protocol.indexOf("https:")&&S("Insecure Wilddog access from a secure page. Please use https in calls to new Wilddog().");
...
V.prototype.ge=function(a,b){L("Wilddog.setPriority",1,2,arguments.length);Qg("Wilddog.setPriority",this.path);Mg("Wilddog.setPriority",1,a);N("Wilddog.setPriority",2,b,!0);this.A.bb(this.path.G(".priority"),a,null,b)};V.prototype.setPriority=V.prototype.ge;V.prototype.push=function(a,b){L("Wilddog.push",0,2,arguments.length);Qg("Wilddog.push",this.path);Ig("Wilddog.push",a,this.path,!0);N("Wilddog.push",2,b,!0);var c=wh(this.A),c=Ve(c),c=this.G(c);"undefined"!==typeof a&&null!==a&&c.set(a,b);return c};
...
V.prototype.rc=function(a){L("Wilddog.unauth",0,1,arguments.length);N("Wilddog.unauth",1,a,!0);yg(this.A.U,a)};V.prototype.unauth=V.prototype.rc;V.prototype.Ic=function(){L("Wilddog.getAuth",0,0,arguments.length);return this.A.U.Ic()};V.prototype.getAuth=V.prototype.Ic;V.prototype.Yd=function(a,b){L("Wilddog.onAuth",1,2,arguments.length);N("Wilddog.onAuth",1,a,!1);zb("Wilddog.onAuth",2,b);this.A.U.Za("auth_status",a,b)};V.prototype.onAuth=V.prototype.Yd;
V.prototype.Xd=function(a,b){L("Wilddog.offAuth",1,2,arguments.length);N("Wilddog.offAuth",1,a,!1);zb("Wilddog.offAuth",2,b);this.A.U.xb("auth_status",a,b)};V.prototype.offAuth=V.prototype.Xd;V.prototype.Id=function(a,b,c){L("Wilddog.authWithCustomToken",2,3,arguments.length);Rg("Wilddog.authWithCustomToken",a);N("Wilddog.authWithCustomToken",2,b,!1);Tg("Wilddog.authWithCustomToken",3,c,!0);xg(this.A.U,a,{},c||{},b)};V.prototype.authWithCustomToken=V.prototype.Id;
V.prototype.Jd=function(a,b,c){L("Wilddog.authWithOAuthPopup",2,3,arguments.length);Sg("Wilddog.authWithOAuthPopup",1,a);N("Wilddog.authWithOAuthPopup",2,b,!1);Tg("Wilddog.authWithOAuthPopup",3,c,!0);Cg(this.A.U,a,c,b)};V.prototype.authWithOAuthPopup=V.prototype.Jd;
V.prototype.Kd=function(a,b,c){L("Wilddog.authWithOAuthRedirect",2,3,arguments.length);Sg("Wilddog.authWithOAuthRedirect",1,a);N("Wilddog.authWithOAuthRedirect",2,b,!1);Tg("Wilddog.authWithOAuthRedirect",3,c,!0);var d=this.A.U;Ag(d);var e=[bc],f=xb(c);"anonymous"===a||"wilddog"===a?T(b,I("TRANSPORT_UNAVAILABLE")):(K.set("redirect_client_options",f.Vb),Bg(d,e,"/auth/"+a,f,b))};V.prototype.authWithOAuthRedirect=V.prototype.Kd;
V.prototype.Ld=function(a,b,c,d){L("Wilddog.authWithOAuthToken",3,4,arguments.length);Sg("Wilddog.authWithOAuthToken",1,a);N("Wilddog.authWithOAuthToken",3,c,!1);Tg("Wilddog.authWithOAuthToken",4,d,!0);p(b)?(Sg("Wilddog.authWithOAuthToken",2,b),zg(this.A.U,a+"/token",{access_token:b},d,c)):(Tg("Wilddog.authWithOAuthToken",2,b,!1),zg(this.A.U,a+"/token",b,d,c))};V.prototype.authWithOAuthToken=V.prototype.Ld;
V.prototype.Hd=function(a,b){L("Wilddog.authAnonymously",1,2,arguments.length);N("Wilddog.authAnonymously",1,a,!1);Tg("Wilddog.authAnonymously",2,b,!0);zg(this.A.U,"anonymous",{},b,a)};V.prototype.authAnonymously=V.prototype.Hd;
V.prototype.Md=function(a,b,c){L("Wilddog.authWithPassword",2,3,arguments.length);Tg("Wilddog.authWithPassword",1,a,!1);Ug("Wilddog.authWithPassword",a,"email");Ug("Wilddog.authWithPassword",a,"password");N("Wilddog.authAnonymously",2,b,!1);Tg("Wilddog.authAnonymously",3,c,!0);zg(this.A.U,"password",a,c,b)};V.prototype.authWithPassword=V.prototype.Md;
...
V.enableLogging=md;V.ServerValue={TIMESTAMP:{".sv":"timestamp"}};V.SDK_VERSION=hd;V.INTERNAL=X;V.TEST_ACCESS=Z;1!=NODE_CLIENT?("object"==typeof module&&module.exports&&(module.exports=V),"function"==typeof define&&define.amd&&define("Wilddog",[],function(){return V}),window?window.Wilddog=V:WorkerGlobalScope&&self&&(self.Wilddog=V)):module.exports=V;
